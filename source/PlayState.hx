...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		// "GLOBAL" SCRIPTS
		#if LUA_ALLOWED
		var daScripts:Array<String> = ['camFollow', 'hud', 'holdcover', 'script3', 'script4']; // I don't think I need to explain this 
		...
		#if LUA_ALLOWED
		var daScripts:Array<String> = ['theending', 'Zoom Girlfriend', 'script2', 'script3', 'script4']; // I don't think I need to explain this 
		for (script in daScripts) {
	...
	public function reloadHealthBarColors() {
		...
		timeBar.createGradientBar(FlxColor.TRANSPARENT(dad.healthColorArray[0], dad.healthColorArray[1], dad.healthColorArray[2]),
			FlxColor.TRANSPARENT(boyfriend.healthColorArray[0], boyfriend.healthColorArray[1], boyfriend.healthColorArray[2]));
