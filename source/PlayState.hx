...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		#if LUA_ALLOWED
		var daScripts:Array<String> = ['theending', 'script1', 'script2', 'script3', 'script4']; // I don't think I need to explain this 
		for (script in daScripts) {
	...
	private function generateSong(dataPath:String):Void
	{
		...
		if (SONG.needsVoices)
			vocals = new FlxSound().loadEmbedded(Paths.voices + CoolUtil.difficultyString() + (PlayState.SONG.song));
		else
			vocals = new FlxSound();
